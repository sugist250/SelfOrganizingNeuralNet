...
def ca_model_run(epoch=100):
    ...
    for _ in tqdm(range(epoch)):
        ...
        for i in range(train_data_num):
            ...
            sum_loss += ca_model.forward(data, t_data)
    ...
    train_log.export_csv('ca_model_train')
    test_log.export_csv('ca_model_test')



if __name__ == '__main__':
    ca_model_run(epoch=10)
